...
$filtersql = "
    ...
    c.CustomerName 
    FROM bookings b
    JOIN Pets pet ON b.PetID = pet.PetID 
...
<body>
    ...
    <div class="container">
        ...
        <form method='POST' action=''>
            ...
            <input type='text' name='searchTerm' placeholder='Enter keyword' value='<?php echo htmlspecialchars($searchTerm); ?>'>
